  ...
  <section class="marquee-section" aria-label="Mitra Industri DUDI">
    <div class="marquee-track">
      <div class="marquee-group">
        ...
        <div class="mitra-item">
          <img src="{{ asset('assets/mitra/2.jpg') }}" alt="Mitra 2" onerror="
                this.closest('.card')
                  ? this.closest('.card').classList.add('no-image')
                  : null;
                this.remove();
        ...
        <div class="mitra-item">
          <img src="{{ asset('assets/mitra/3.jpg') }}" alt="Mitra 3" onerror="
                this.closest('.card')
                  ? this.closest('.card').classList.add('no-image')
                  : null;
                this.remove();
        ...
        <div class="mitra-item">
          <img src="{{ asset('assets/mitra/4.jpg') }}" alt="Mitra 4" onerror="
                this.closest('.card')
                  ? this.closest('.card').classList.add('no-image')
                  : null;
                this.remove();
        ...
        <div class="mitra-item">
          <img src="{{ asset('assets/mitra/5.jpg') }}" alt="Mitra 5" onerror="
                this.closest('.card')
                  ? this.closest('.card').classList.add('no-image')
                  : null;
                this.remove();
        ...
        <div class="mitra-item">
          <img src="{{ asset('assets/mitra/6.jpg') }}" alt="Mitra 6" onerror="
                this.closest('.card')
                  ? this.closest('.card').classList.add('no-image')
                  : null;
                this.remove();
        ...
        <div class="mitra-item">
          <img src="{{ asset('assets/mitra/7.jpg') }}" alt="Mitra 7" onerror="
                this.closest('.card')
                  ? this.closest('.card').classList.add('no-image')
                  : null;
                this.remove();
        ...
        <div class="mitra-item">
          <img src="{{ asset('assets/mitra/8.jpg') }}" alt="Mitra 8" onerror="
                this.closest('.card')
                  ? this.closest('.card').classList.add('no-image')
                  : null;
                this.remove();
        ...
        <div class="mitra-item">
          <img src="{{ asset('assets/mitra/9.jpg') }}" alt="Mitra 9" onerror="
                this.closest('.card')
                  ? this.closest('.card').classList.add('no-image')
                  : null;
                this.remove();
        ...
        <div class="mitra-item">
          <img src="{{ asset('assets/mitra/10.jpg') }}" alt="Mitra 10" onerror="
                this.closest('.card')
                  ? this.closest('.card').classList.add('no-image')
                  : null;
                this.remove();
        ...
        <div class="mitra-item">
          <img src="{{ asset('assets/mitra/11.jpg') }}" alt="Mitra 11" onerror="
                this.closest('.card')
                  ? this.closest('.card').classList.add('no-image')
                  : null;
                this.remove();
        ...
        <div class="mitra-item">
          <img src="{{ asset('assets/mitra/12.jpg') }}" alt="Mitra 12" onerror="
                this.closest('.card')
                  ? this.closest('.card').classList.add('no-image')
                  : null;
                this.remove();
        ...
        <div class="mitra-item">
          <img src="{{ asset('assets/mitra/13.jpg') }}" alt="Mitra 13" onerror="
                this.closest('.card')
                  ? this.closest('.card').classList.add('no-image')
                  : null;
                this.remove();
        ...
        <div class="mitra-item">
          <img src="{{ asset('assets/mitra/14.jpg') }}" alt="Mitra 14" onerror="
                this.closest('.card')
                  ? this.closest('.card').classList.add('no-image')
                  : null;
                this.remove();
        ...
        <div class="mitra-item">
          <img src="{{ asset('assets/mitra/15.jpg') }}" alt="Mitra 15" onerror="
                this.closest('.card')
                  ? this.closest('.card').classList.add('no-image')
                  : null;
                this.remove();
        ...
        <div class="mitra-item">
          <img src="{{ asset('assets/mitra/16.jpg') }}" alt="Mitra 16" onerror="
                this.closest('.card')
                  ? this.closest('.card').classList.add('no-image')
                  : null;
                this.remove();
        ...
        <div class="mitra-item">
          <img src="{{ asset('assets/mitra/17.jpg') }}" alt="Mitra 17" onerror="
                this.closest('.card')
                  ? this.closest('.card').classList.add('no-image')
                  : null;
                this.remove();
        ...
        <div class="mitra-item">
          <img src="{{ asset('assets/mitra/18.jpg') }}" alt="Mitra 18" onerror="
                this.closest('.card')
                  ? this.closest('.card').classList.add('no-image')
                  : null;
                this.remove();
        ...
        <div class="mitra-item">
          <img src="{{ asset('assets/mitra/19.jpg') }}" alt="Mitra 19" onerror="
                this.closest('.card')
                  ? this.closest('.card').classList.add('no-image')
                  : null;
                this.remove();
        ...
        <div class="mitra-item">
          <img src="{{ asset('assets/mitra/20.jpg') }}" alt="Mitra 20" onerror="
                this.closest('.card')
                  ? this.closest('.card').classList.add('no-image')
                  : null;
                this.remove();
        ...
        <div class="mitra-item">
          <img src="{{ asset('assets/mitra/21.jpg') }}" alt="Mitra 21" onerror="
                this.closest('.card')
                  ? this.closest('.card').classList.add('no-image')
                  : null;
                this.remove();
        ...
        <div class="mitra-item">
          <img src="{{ asset('assets/mitra/semesta.webp') }}" alt="Mitra 23" onerror="
                this.closest('.card')
                  ? this.closest('.card').classList.add('no-image')
                  : null;
                this.remove();
        ...
        <div class="mitra-item">
          <img src="{{ asset('assets/mitra/22.jpg') }}" alt="Mitra 22" onerror="
                this.closest('.card')
                  ? this.closest('.card').classList.add('no-image')
                  : null;
                this.remove();
      ...
      <div class="blud-modal-body">
        ...
        <div class="blud-modal-specs-box">
          <div class="blud-modal-section-title">
            <span>🏷️</span> Spesifikasi &amp; Informasi Detail:
          </div>
        ...
        <div class="blud-modal-highlight-box">
          <div class="blud-modal-section-title" style="color: #064e3b; margin-bottom: 0.4rem;">
            <span>✨</span> Nilai Praktik Vokasi &amp; Pembelajaran BLUD:
          </div>
  ...
  <div class="blud-modal-overlay" id="unit-usaha-modal-overlay" onclick="closeUnitUsahaModalOnOverlay(event)"
    ...
    <div class="blud-modal-card" id="unit-usaha-modal-card" data-lenis-prevent>
      ...
      <div class="blud-modal-body">
        ...
        <div class="blud-modal-specs-box">
          <div class="blud-modal-section-title">
            <span>🏷️</span> Layanan &amp; Keunggulan Utama:
          </div>
        ...
        <div class="blud-modal-highlight-box">
          <div class="blud-modal-section-title" style="color: #064e3b; margin-bottom: 0.4rem;">
            <span>✨</span> Nilai Ekosistem Vokasi &amp; Praktik Industri:
          </div>

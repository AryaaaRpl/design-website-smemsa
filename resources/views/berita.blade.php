...
@section('content')
    ...
    <div class="mobile-drawer" id="mobile-drawer">
        ...
        <div class="brand-box" style="margin-bottom: 2rem;">
            <img src="{{ asset('assets/logo.webp') }}" alt="Logo SMKS MUHI" class="brand-logo"
                onerror="this.closest('.card') ? this.closest('.card').classList.add('no-image') : null; this.remove();">
            <div>
                <strong style="color:var(--primary); font-size:1.1rem; display:block;">SMKS MUHI GENTENG</strong>
        ...
        <div class="drawer-links">
            ...
            <a href="/berita" class="active">📰 Jurnal & Kabar Kampus</a>
            ...
            <div style="margin-top: 1.5rem;">
                <a href="index.html#ppdb" class="btn btn-primary"
